...
import { usePaneLayout, ChildLink, BackLink, ReferenceChildLink, ParameterizedLink, PaneRouterContext, useDeskTool, LOADING_PANE, structureLocaleNamespace, SerializeError, Pane, PaneHeader, PaneContent, LoadingPane, PaneLayout, setActivePanes, DeskToolProvider } from './desk-Eujs1xHU.js';
...
const paneMap = {
  component: lazy(() => import('./index-1wSzAaR9.js')),
  document: lazy(() => import('./pane-OAGFHC3-.js')),
  documentList: lazy(() => import('./pane-DmSepQK0.js')),
  list: lazy(() => import('./index-HL5sqOs_.js'))
};
...
//# sourceMappingURL=index-9GJLCmXa.js.map
